...
We recommend migrating to the latest version of ArchivesSpace when possible. There are multiple versions of the migration tool available here: https://github.com/archivesspace/at-migration/releases. The corresponding ArchivesSpace version numbers are noted in the release notes. Make sure you select the migration tool version for the ArchivesSpace version you are migrating into.
